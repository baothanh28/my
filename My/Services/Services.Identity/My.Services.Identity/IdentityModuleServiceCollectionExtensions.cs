using My.Services.Identity;
using My.Services.Identity.Authorization;
using My.Services.Identity.ConfigurationOptions;
using My.Services.Identity.Entities;
using My.Services.Identity.HostedServices;
using My.Services.Identity.IdentityProviders.Auth0;
using My.Services.Identity.IdentityProviders.Azure;
using My.Services.Identity.PasswordValidators;
...
public static class IdentityModuleServiceCollectionExtensions
{
    ...
    {
        services.AddDbContext<IdentityDbContext>(options => options.UseSqlServer(appSettings.ConnectionStrings.My, sql =>
        {
